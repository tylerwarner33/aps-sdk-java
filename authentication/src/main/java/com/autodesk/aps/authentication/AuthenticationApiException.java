...
/**
 * Exception thrown when an error occurs during APS Authentication API
 * operations.
 */
public class AuthenticationApiException extends RuntimeException {
    ...
    /**
     * Initializes a new instance of the AuthenticationApiException class with a
     * specified cause.
     * 
    ...
    /**
     * Initializes a new instance of the AuthenticationApiException class with a
     * specified HTTP status code and error message.
     * 
    ...
    /**
     * Initializes a new instance of the AuthenticationApiException class with a
     * specified error message, HTTP status code, and response body.
     * 
     * @param message      The error message.
     * @param statusCode   The HTTP status code.
    ...
    /**
     * Initializes a new instance of the AuthenticationApiException class with a
     * specified error message, HTTP status code, response body, and a reference to
