...
public class BaseApi {
    ...
    String userAgent = "APS SDK/OSS/JAVA/1.0.0";
    ...
    public <T> ClassicHttpResponse invokeGenericAPI(
            String url,
            String method,
            Map<String, String> queryParams,
            Object body,
            Map<String, String> headerParams,
            Map<String, Object> formParams) throws OssApiException {
        try {
            if (body != null && formParams != null && !formParams.isEmpty()) {
                throw new OssApiException("Cannot have body and form params");
            }
    ...
    public String parameterToString(Object param) {
        if (param instanceof LocalDateTime) {
            DateTimeFormatter gmtFormat = DateTimeFormatter.ofPattern("E, dd MMM yyyy HH:mm:ss 'GMT'")
                    .withZone(java.time.ZoneOffset.UTC);
            ZonedDateTime gmtDateTime = ((LocalDateTime) param).atZone(java.time.ZoneId.systemDefault());
            return gmtDateTime.format(gmtFormat);
        }
