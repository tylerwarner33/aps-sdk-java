...
package com.autodesk.aps.datamanagement.model;  
 ...
 /**
  * Represents optional parameters for the `createVersion` method.
  * This class uses the Builder pattern to allow flexible construction of objects.
  */
public class CreateVersionOptionalParams{
    private String xUserId;    
    private String copyFrom;    
    private String accessToken;

    private CreateVersionOptionalParams(Builder builder){
...
this.copyFrom = builder.copyFrom;    
    ...
    /**
     * Builder class for constructing instances of CreateVersionOptionalParams.
     */
 ...
 * 
        ...
        /**
         * Builds and returns an instance of CreateVersionOptionalParams.
         * 
         * @return CreateVersionOptionalParams object.
         */
        public CreateVersionOptionalParams build() {
            return new CreateVersionOptionalParams(this);
        }
    }
