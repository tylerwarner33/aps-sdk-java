 ...
 */
@Schema(description = "An object representing a hub.")
@JsonPropertyOrder({
    Hub.JSON_PROPERTY_JSONAPI,
    Hub.JSON_PROPERTY_LINKS,
    Hub.JSON_PROPERTY_DATA
})
@JsonTypeName("Hub")
...
public class Hub {
  ...
  public Hub jsonapi(JsonApiVersion jsonapi) {
  ...
  public Hub links(JsonApiLinksSelf links) {
  ...
  @JsonProperty(JSON_PROPERTY_DATA)
  @JsonInclude(value = JsonInclude.Include.NON_NULL)
  public void setData(HubData data) {
    this.data = data;
  }
