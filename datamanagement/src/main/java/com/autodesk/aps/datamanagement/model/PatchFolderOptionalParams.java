...
package com.autodesk.aps.datamanagement.model;  
 ...
 /**
  * Represents optional parameters for the `patchFolder` method.
  * This class uses the Builder pattern to allow flexible construction of objects.
  */
public class PatchFolderOptionalParams{
    private String xUserId;    
    private String accessToken;

    private PatchFolderOptionalParams(Builder builder){
    ...
    /**
     * Builder class for constructing instances of PatchFolderOptionalParams.
     */
    public static class Builder {
        ...
        /**
         * Builds and returns an instance of PatchFolderOptionalParams.
         * 
         * @return PatchFolderOptionalParams object.
         */
        public PatchFolderOptionalParams build() {
            return new PatchFolderOptionalParams(this);
        }
    }
