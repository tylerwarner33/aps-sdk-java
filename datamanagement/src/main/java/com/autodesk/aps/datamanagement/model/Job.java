 ...
 */
@Schema(description = "Details of the specified job was returned successfully.")
@JsonPropertyOrder({
    Job.JSON_PROPERTY_JSONAPI,
...
public class Job {
  ...
  public Job jsonapi(JsonApiVersion jsonapi) {
  ...
  public Job links(JsonApiLinksSelf links) {
  ...
  public boolean equals(Object o) {
    ...
    Job job = (Job) o;
    return Objects.equals(this.jsonapi, job.jsonapi) &&
