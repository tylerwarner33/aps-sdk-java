...
package com.autodesk.aps.datamanagement.model;  
 ...
 /**
  * Represents optional parameters for the `getItemTip` method.
  * This class uses the Builder pattern to allow flexible construction of objects.
  */
public class GetItemTipOptionalParams{
    private String xUserId;    
    private String accessToken;

    private GetItemTipOptionalParams(Builder builder){
    ...
    /**
     * Builder class for constructing instances of GetItemTipOptionalParams.
     */
    public static class Builder {
        ...
        /**
         * Builds and returns an instance of GetItemTipOptionalParams.
         * 
         * @return GetItemTipOptionalParams object.
         */
        public GetItemTipOptionalParams build() {
            return new GetItemTipOptionalParams(this);
        }
    }
