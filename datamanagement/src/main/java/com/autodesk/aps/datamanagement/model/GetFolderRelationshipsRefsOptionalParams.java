...
/**
 * Represents optional parameters for the `getFolderRelationshipsRefs` method.
 * This class uses the Builder pattern to allow flexible construction of
 * objects.
 */
public class GetFolderRelationshipsRefsOptionalParams {
    ...
    private GetFolderRelationshipsRefsOptionalParams(Builder builder) {
    ...
    public static class Builder {
        ...
        /**
         * Builds and returns an instance of GetFolderRelationshipsRefsOptionalParams.
         * 
         * @return GetFolderRelationshipsRefsOptionalParams object.
         */
        public GetFolderRelationshipsRefsOptionalParams build() {
            return new GetFolderRelationshipsRefsOptionalParams(this);
        }
    }
