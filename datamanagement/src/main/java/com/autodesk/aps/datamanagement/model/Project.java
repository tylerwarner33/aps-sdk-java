 ...
 */
@Schema(description = "An object that represents a project.")
@JsonPropertyOrder({
    Project.JSON_PROPERTY_JSONAPI,
    Project.JSON_PROPERTY_LINKS,
    Project.JSON_PROPERTY_DATA
})
...
public class Project {
  ...
  public Project jsonapi(JsonApiVersion jsonapi) {
  ...
  public Project links(JsonApiLinksSelf links) {
  ...
  public Project data(ProjectData data) {
