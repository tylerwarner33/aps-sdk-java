...
package com.autodesk.aps.datamanagement.model;  
 ...
 /**
  * Represents optional parameters for the `getProject` method.
  * This class uses the Builder pattern to allow flexible construction of objects.
  */
public class GetProjectOptionalParams{
    private String xUserId;    
    private String accessToken;

    private GetProjectOptionalParams(Builder builder){
    ...
    /**
     * Builder class for constructing instances of GetProjectOptionalParams.
     */
    public static class Builder {
        ...
        /**
         * Builds and returns an instance of GetProjectOptionalParams.
         * 
         * @return GetProjectOptionalParams object.
         */
        public GetProjectOptionalParams build() {
            return new GetProjectOptionalParams(this);
        }
    }
