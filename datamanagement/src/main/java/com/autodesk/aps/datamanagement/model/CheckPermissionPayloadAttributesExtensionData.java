 ...
 */
@Schema(description = "Contains the properties specific to the  CheckPermission command.")
@JsonPropertyOrder({
    CheckPermissionPayloadAttributesExtensionData.JSON_PROPERTY_REQUIRED_ACTIONS
})
@JsonTypeName("CheckPermissionPayload_attributes_extension_data")
...
public class CheckPermissionPayloadAttributesExtensionData {
  ...
  public CheckPermissionPayloadAttributesExtensionData requiredActions(List<String> requiredActions) {

    this.requiredActions = requiredActions;
    return this;
  }

  public CheckPermissionPayloadAttributesExtensionData addrequiredActionsItem(String requiredActionsItem) {
  ...
  public boolean equals(Object o) {
    ...
    CheckPermissionPayloadAttributesExtensionData checkPermissionPayloadAttributesExtensionData = (CheckPermissionPayloadAttributesExtensionData) o;
    return Objects.equals(this.requiredActions, checkPermissionPayloadAttributesExtensionData.requiredActions);
  }

  @Override
  public int hashCode() {
    return Objects.hash(requiredActions);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class CheckPermissionPayloadAttributesExtensionData {\n");
