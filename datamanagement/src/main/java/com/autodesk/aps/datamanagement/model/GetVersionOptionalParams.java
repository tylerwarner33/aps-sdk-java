...
package com.autodesk.aps.datamanagement.model;  
 ...
 /**
  * Represents optional parameters for the `getVersion` method.
  * This class uses the Builder pattern to allow flexible construction of objects.
  */
public class GetVersionOptionalParams{
    private String xUserId;    
    private String accessToken;

    private GetVersionOptionalParams(Builder builder){
    ...
    /**
     * Builder class for constructing instances of GetVersionOptionalParams.
     */
    public static class Builder {
        ...
        /**
         * Builds and returns an instance of GetVersionOptionalParams.
         * 
         * @return GetVersionOptionalParams object.
         */
        public GetVersionOptionalParams build() {
            return new GetVersionOptionalParams(this);
        }
    }
