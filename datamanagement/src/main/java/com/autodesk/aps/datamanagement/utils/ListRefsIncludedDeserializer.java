...
import com.autodesk.aps.datamanagement.model.ListRefsIncluded;
...
public class ListRefsIncludedDeserializer extends JsonDeserializer<ListRefsIncluded> {
    ...
    @Override
    public ListRefsIncluded deserialize(JsonParser jp, DeserializationContext ctxt) throws IOException {
        ...
        if (typeNode != null) {
            ...
            CLEAN_MAPPER.addMixIn(ListRefsIncluded.class, NoCustomDeserializerMixIn.class);
        ...
        throw new IllegalArgumentException("Unknown or missing type in ListRefsIncluded");
    }
}