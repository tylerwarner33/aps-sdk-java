...
import com.autodesk.aps.datamanagement.model.FolderContentsData;
...
public class FolderContentsDataDeserializer extends JsonDeserializer<FolderContentsData> {
    ...
    @Override
    public FolderContentsData deserialize(JsonParser jp, DeserializationContext ctxt) throws IOException {
        ...
        if (typeNode != null) {
            ...
            CLEAN_MAPPER.addMixIn(FolderContentsData.class, NoCustomDeserializerMixIn.class);
        ...
        throw new IllegalArgumentException("Unknown or missing type in FolderContentsData");
    }
}
