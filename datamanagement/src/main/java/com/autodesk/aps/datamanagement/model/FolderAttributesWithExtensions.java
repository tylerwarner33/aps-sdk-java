...
@JsonPropertyOrder({
    FolderAttributesWithExtensions.JSON_PROPERTY_NAME,
    FolderAttributesWithExtensions.JSON_PROPERTY_DISPLAY_NAME,
    FolderAttributesWithExtensions.JSON_PROPERTY_OBJECT_COUNT,
    FolderAttributesWithExtensions.JSON_PROPERTY_CREATE_TIME,
    FolderAttributesWithExtensions.JSON_PROPERTY_CREATE_USER_ID,
    FolderAttributesWithExtensions.JSON_PROPERTY_CREATE_USER_NAME,
    FolderAttributesWithExtensions.JSON_PROPERTY_LAST_MODIFIED_TIME,
    FolderAttributesWithExtensions.JSON_PROPERTY_LAST_MODIFIED_USER_ID,
    FolderAttributesWithExtensions.JSON_PROPERTY_LAST_MODIFIED_USER_NAME,
    FolderAttributesWithExtensions.JSON_PROPERTY_LAST_MODIFIED_TIME_ROLLUP,
    FolderAttributesWithExtensions.JSON_PROPERTY_HIDDEN,
    FolderAttributesWithExtensions.JSON_PROPERTY_EXTENSION
})
@JsonTypeName("FolderAttributesWithExtensions")
...
public class FolderAttributesWithExtensions {
  ...
  private FolderExtensionWithSchemaLink extension;

  public FolderAttributesWithExtensions name(String name) {
  ...
  public FolderAttributesWithExtensions displayName(String displayName) {
  ...
  public FolderAttributesWithExtensions objectCount(BigDecimal objectCount) {
  ...
  public FolderAttributesWithExtensions createTime(OffsetDateTime createTime) {
  ...
  public FolderAttributesWithExtensions createUserId(String createUserId) {
  ...
  public FolderAttributesWithExtensions createUserName(String createUserName) {
  ...
  public FolderAttributesWithExtensions lastModifiedTime(OffsetDateTime lastModifiedTime) {
  ...
  public FolderAttributesWithExtensions lastModifiedUserId(String lastModifiedUserId) {
  ...
  public FolderAttributesWithExtensions lastModifiedUserName(String lastModifiedUserName) {
  ...
  public FolderAttributesWithExtensions lastModifiedTimeRollup(String lastModifiedTimeRollup) {
  ...
  public FolderAttributesWithExtensions hidden(Boolean hidden) {
  ...
  public FolderAttributesWithExtensions extension(FolderExtensionWithSchemaLink extension) {
  ...
  public FolderExtensionWithSchemaLink getExtension() {
    return extension;
  }

  @JsonProperty(JSON_PROPERTY_EXTENSION)
  @JsonInclude(value = JsonInclude.Include.NON_NULL)
  public void setExtension(FolderExtensionWithSchemaLink extension) {
    this.extension = extension;
  }
  ...
  public boolean equals(Object o) {
    ...
    FolderAttributesWithExtensions folderAttributesWithExtensions = (FolderAttributesWithExtensions) o;
    return Objects.equals(this.name, folderAttributesWithExtensions.name) &&
        Objects.equals(this.displayName, folderAttributesWithExtensions.displayName) &&
        Objects.equals(this.objectCount, folderAttributesWithExtensions.objectCount) &&
        Objects.equals(this.createTime, folderAttributesWithExtensions.createTime) &&
        Objects.equals(this.createUserId, folderAttributesWithExtensions.createUserId) &&
        Objects.equals(this.createUserName, folderAttributesWithExtensions.createUserName) &&
        Objects.equals(this.lastModifiedTime, folderAttributesWithExtensions.lastModifiedTime) &&
        Objects.equals(this.lastModifiedUserId, folderAttributesWithExtensions.lastModifiedUserId) &&
        Objects.equals(this.lastModifiedUserName, folderAttributesWithExtensions.lastModifiedUserName) &&
        Objects.equals(this.lastModifiedTimeRollup, folderAttributesWithExtensions.lastModifiedTimeRollup) &&
        Objects.equals(this.hidden, folderAttributesWithExtensions.hidden) &&
        Objects.equals(this.extension, folderAttributesWithExtensions.extension);
  }
  ...
  public String toString() {
    ...
    sb.append("class FolderAttributesWithExtensions {\n");
