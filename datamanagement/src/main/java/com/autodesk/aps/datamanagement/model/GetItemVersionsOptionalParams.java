...
/**
 * Represents optional parameters for the `getItemVersions` method.
 * This class uses the Builder pattern to allow flexible construction of
 * objects.
 */
public class GetItemVersionsOptionalParams {
    private String xUserId;
    private List<String> filterId;
    private List<String> filterExtensionType;
    private List<Integer> filterVersionNumber;
    private Integer pageNumber;
    private Integer pageLimit;
    private String accessToken;

    private GetItemVersionsOptionalParams(Builder builder) {
        this.xUserId = builder.xUserId;
        this.filterId = builder.filterId;
        this.filterExtensionType = builder.filterExtensionType;
        this.filterVersionNumber = builder.filterVersionNumber;
    ...
    /**
     * Builder class for constructing instances of GetItemVersionsOptionalParams.
     */
    public static class Builder {
        ...
        /**
         * @param filterVersionNumber Filter by versionNumber.
         *
         * @return The Builder instance for chaining.
         */
        public Builder filterVersionNumber(List<Integer> filterVersionNumber) {
            this.filterVersionNumber = filterVersionNumber;
            return this;
        }
        ...
        /**
         * Builds and returns an instance of GetItemVersionsOptionalParams.
         * 
         * @return GetItemVersionsOptionalParams object.
         */
        public GetItemVersionsOptionalParams build() {
            return new GetItemVersionsOptionalParams(this);
        }
    }
    ...
    /**
     * Gets the filterVersionNumber value.
     *
     * @return List&lt;Integer&gt;
     */
    public List<Integer> getFilterVersionNumber() {
        return filterVersionNumber;
    }
