...
/**
 * Represents optional parameters for the `getVersionRefs` method.
 * This class uses the Builder pattern to allow flexible construction of
 * objects.
 */
public class GetVersionRefsOptionalParams {
    ...
    private GetVersionRefsOptionalParams(Builder builder) {
    ...
    /**
     * Builder class for constructing instances of GetVersionRefsOptionalParams.
     */
    public static class Builder {
        ...
        /**
         * Builds and returns an instance of GetVersionRefsOptionalParams.
         * 
         * @return GetVersionRefsOptionalParams object.
         */
        public GetVersionRefsOptionalParams build() {
            return new GetVersionRefsOptionalParams(this);
        }
    }
