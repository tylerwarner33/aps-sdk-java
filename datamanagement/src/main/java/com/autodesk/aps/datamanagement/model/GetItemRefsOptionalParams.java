...
/**
 * Represents optional parameters for the `getItemRefs` method.
 * This class uses the Builder pattern to allow flexible construction of
 * objects.
 */
public class GetItemRefsOptionalParams {
    ...
    private GetItemRefsOptionalParams(Builder builder) {
    ...
    /**
     * Builder class for constructing instances of GetItemRefsOptionalParams.
     */
    public static class Builder {
        ...
        /**
         * Builds and returns an instance of GetItemRefsOptionalParams.
         * 
         * @return GetItemRefsOptionalParams object.
         */
        public GetItemRefsOptionalParams build() {
            return new GetItemRefsOptionalParams(this);
        }
    }
