...
package com.autodesk.aps.datamanagement.model;  
 ...
 /**
  * Represents optional parameters for the `getItem` method.
  * This class uses the Builder pattern to allow flexible construction of objects.
  */
public class GetItemOptionalParams{
    private String xUserId;    
    private Boolean includePathInProject;    
    private String accessToken;

    private GetItemOptionalParams(Builder builder){
        this.xUserId = builder.xUserId;    
this.includePathInProject = builder.includePathInProject;    
        this.accessToken = builder.accessToken;
    }

    
    /**
     * Builder class for constructing instances of GetItemOptionalParams.
     */
 ...
 private Boolean includePathInProject;    
        ...
        /**
         * @param includePathInProject Specify whether to return &#x60;&#x60;pathInProject&#x60;&#x60; attribute in response for BIM 360 Docs projects. &#x60;&#x60;pathInProject&#x60;&#x60; is the relative path of the item starting from project’s root folder. 
 * 
 ...
 * 
         ...
         * @return The Builder instance for chaining.
         */
        public Builder includePathInProject(Boolean includePathInProject){
        ...
        /**
         * Builds and returns an instance of GetItemOptionalParams.
         * 
         * @return GetItemOptionalParams object.
         */
        public GetItemOptionalParams build() {
            return new GetItemOptionalParams(this);
        }
    }
    ...
    /**
     * Gets the includePathInProject value.
     *
     * @return Boolean
     */
