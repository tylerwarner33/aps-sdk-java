 ...
 */
@Schema(description = "An object that represents a folder.")
@JsonPropertyOrder({
    Folder.JSON_PROPERTY_JSONAPI,
    Folder.JSON_PROPERTY_LINKS,
    Folder.JSON_PROPERTY_DATA
})
@JsonTypeName("Folder")
...
public class Folder {
  ...
  public Folder jsonapi(JsonApiVersion jsonapi) {
  ...
  public Folder links(JsonApiLinksSelf links) {
  ...
  public Folder data(FolderData data) {
  ...
  @JsonProperty(JSON_PROPERTY_DATA)
  @JsonInclude(value = JsonInclude.Include.NON_NULL)
  public void setData(FolderData data) {
    this.data = data;
  }
