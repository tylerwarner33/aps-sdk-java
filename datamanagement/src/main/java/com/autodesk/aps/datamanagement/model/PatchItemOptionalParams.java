...
package com.autodesk.aps.datamanagement.model;  
 ...
 /**
  * Represents optional parameters for the `patchItem` method.
  * This class uses the Builder pattern to allow flexible construction of objects.
  */
public class PatchItemOptionalParams{
    private String xUserId;    
    private String accessToken;

    private PatchItemOptionalParams(Builder builder){
    ...
    /**
     * Builder class for constructing instances of PatchItemOptionalParams.
     */
    public static class Builder {
        ...
        /**
         * Builds and returns an instance of PatchItemOptionalParams.
         * 
         * @return PatchItemOptionalParams object.
         */
        public PatchItemOptionalParams build() {
            return new PatchItemOptionalParams(this);
        }
    }
