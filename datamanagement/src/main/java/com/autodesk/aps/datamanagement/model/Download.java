 ...
 */
@Schema(description = "An object that represents a download.")
@JsonPropertyOrder({
    Download.JSON_PROPERTY_JSONAPI,
    Download.JSON_PROPERTY_LINKS,
    Download.JSON_PROPERTY_DATA
})
...
public class Download {
  ...
  public Download jsonapi(JsonApiVersion jsonapi) {
  ...
  public Download links(JsonApiLinksSelf links) {
  ...
  public Download data(DownloadData data) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.jsonapi, download.jsonapi) &&
        Objects.equals(this.links, download.links) &&
        Objects.equals(this.data, download.data);
  }
