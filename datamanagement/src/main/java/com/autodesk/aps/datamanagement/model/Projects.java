 ...
 */
@Schema(description = "An object representing a collection of projects within a hub.")
@JsonPropertyOrder({
  Projects.JSON_PROPERTY_JSONAPI,
  Projects.JSON_PROPERTY_LINKS,
  Projects.JSON_PROPERTY_DATA
})
...
public class Projects {
  ...
  public Projects jsonapi(JsonApiVersion jsonapi) {
  ...
  **/
  ...
  public Projects links(PaginationInfo links) {
  ...
  **/
  ...
  public Projects data(List<ProjectData> data) {
    
    this.data = data;
    return this;
  }

  public Projects adddataItem(ProjectData dataItem) {
    if (this.data == null) {
  ...
  **/
  @javax.annotation.Nullable
  @Schema(description = "An array of objects where each object represents a project.")
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.jsonapi, projects.jsonapi) &&
        Objects.equals(this.links, projects.links) &&
