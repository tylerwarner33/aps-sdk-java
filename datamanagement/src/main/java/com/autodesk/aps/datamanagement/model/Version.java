 ...
 */
@Schema(description = "An object that represdents a version.")
@JsonPropertyOrder({
    Version.JSON_PROPERTY_JSONAPI,
    Version.JSON_PROPERTY_LINKS,
    Version.JSON_PROPERTY_DATA
})
...
public class Version {
  ...
  public Version jsonapi(JsonApiVersion jsonapi) {
  ...
  public Version links(JsonApiLinksSelf links) {
  ...
  public Version data(VersionData data) {
