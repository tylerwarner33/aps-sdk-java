...
import com.autodesk.aps.datamanagement.model.FolderRefsData;
...
public class FolderRefsDataDeserializer extends JsonDeserializer<FolderRefsData> {
    ...
    @Override
    public FolderRefsData deserialize(JsonParser jp, DeserializationContext ctxt) throws IOException {
        ...
        if (typeNode != null) {
            ...
            CLEAN_MAPPER.addMixIn(FolderRefsData.class, NoCustomDeserializerMixIn.class);
        ...
        throw new IllegalArgumentException("Unknown or missing type in FolderRefsData");
    }
}
