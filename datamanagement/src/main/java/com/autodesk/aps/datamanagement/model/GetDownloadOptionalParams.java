...
package com.autodesk.aps.datamanagement.model;  
 ...
 /**
  * Represents optional parameters for the `getDownload` method.
  * This class uses the Builder pattern to allow flexible construction of objects.
  */
public class GetDownloadOptionalParams{
    private String xUserId;    
    private String accessToken;

    private GetDownloadOptionalParams(Builder builder){
    ...
    /**
     * Builder class for constructing instances of GetDownloadOptionalParams.
     */
    public static class Builder {
        ...
        /**
         * Builds and returns an instance of GetDownloadOptionalParams.
         * 
         * @return GetDownloadOptionalParams object.
         */
        public GetDownloadOptionalParams build() {
            return new GetDownloadOptionalParams(this);
        }
    }
