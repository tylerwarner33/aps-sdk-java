...
@JsonPropertyOrder({
    CommandPayload.JSON_PROPERTY_JSONAPI,
    CommandPayload.JSON_PROPERTY_DATA
})
...
public class CommandPayload {
  ...
  private CommandPayloadData data;

  public CommandPayload jsonapi(JsonApiVersion jsonapi) {
  ...
  public CommandPayload data(CommandPayloadData data) {
  ...
  public CommandPayloadData getData() {
    return data;
  }

  @JsonProperty(JSON_PROPERTY_DATA)
  @JsonInclude(value = JsonInclude.Include.NON_NULL)
  public void setData(CommandPayloadData data) {
    this.data = data;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.jsonapi, commandPayload.jsonapi) &&
        Objects.equals(this.data, commandPayload.data);
  }
