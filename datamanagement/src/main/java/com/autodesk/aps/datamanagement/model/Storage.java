 ...
 */
@Schema(description = "An object representing a storage location.")
@JsonPropertyOrder({
    Storage.JSON_PROPERTY_JSONAPI,
    Storage.JSON_PROPERTY_LINKS,
    Storage.JSON_PROPERTY_DATA
})
...
public class Storage {
  ...
  public Storage jsonapi(JsonApiVersion jsonapi) {
  ...
  public Storage links(JsonApiLinksSelf links) {
  ...
  public Storage data(StorageData data) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.jsonapi, storage.jsonapi) &&
        Objects.equals(this.links, storage.links) &&
        Objects.equals(this.data, storage.data);
  }
