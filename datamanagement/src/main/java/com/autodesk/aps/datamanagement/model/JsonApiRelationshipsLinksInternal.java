 ...
 */
@Schema(description = "Information on resources that are found under this resource.")
@JsonPropertyOrder({
    JsonApiRelationshipsLinksInternal.JSON_PROPERTY_LINKS
})
@JsonTypeName("json_api_relationships_links_internal")
