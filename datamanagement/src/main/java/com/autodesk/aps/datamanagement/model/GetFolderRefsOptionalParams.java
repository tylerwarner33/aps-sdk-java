...
/**
 * Represents optional parameters for the `getFolderRefs` method.
 * This class uses the Builder pattern to allow flexible construction of
 * objects.
 */
public class GetFolderRefsOptionalParams {
    ...
    private GetFolderRefsOptionalParams(Builder builder) {
    ...
    /**
     * Builder class for constructing instances of GetFolderRefsOptionalParams.
     */
    public static class Builder {
        ...
        /**
         * Builds and returns an instance of GetFolderRefsOptionalParams.
         * 
         * @return GetFolderRefsOptionalParams object.
         */
        public GetFolderRefsOptionalParams build() {
            return new GetFolderRefsOptionalParams(this);
        }
    }
