...
import com.autodesk.aps.datamanagement.model.RelationshipRefsIncluded;
...
public class RelationshipRefsIncludedDeserializer extends JsonDeserializer<RelationshipRefsIncluded> {
    ...
    @Override
    public RelationshipRefsIncluded deserialize(JsonParser jp, DeserializationContext ctxt) throws IOException {
        ...
        if (typeNode != null) {
            ...
            CLEAN_MAPPER.addMixIn(RelationshipRefsIncluded.class, NoCustomDeserializerMixIn.class);
        ...
        throw new IllegalArgumentException("Unknown or missing type in RelationshipRefsIncluded");
    }
}