...
package com.autodesk.aps.datamanagement.model;  
 ...
 /**
  * Represents optional parameters for the `createFolder` method.
  * This class uses the Builder pattern to allow flexible construction of objects.
  */
public class CreateFolderOptionalParams{
    private String xUserId;    
    private String accessToken;

    private CreateFolderOptionalParams(Builder builder){
    ...
    /**
     * Builder class for constructing instances of CreateFolderOptionalParams.
     */
    public static class Builder {
        ...
        /**
         * Builds and returns an instance of CreateFolderOptionalParams.
         * 
         * @return CreateFolderOptionalParams object.
         */
        public CreateFolderOptionalParams build() {
            return new CreateFolderOptionalParams(this);
        }
    }
