 ...
 * &#x60;&#x60;failed&#x60;&#x60; - There was an error and command execution was
 * stopped prematurely.
 */
public enum CommandExecutionStatus {
  ...
  CommandExecutionStatus(String value) {
    this.value = value;
  }
  ...
  @JsonCreator
  public static CommandExecutionStatus fromValue(String value) {
    for (CommandExecutionStatus b : CommandExecutionStatus.values()) {
