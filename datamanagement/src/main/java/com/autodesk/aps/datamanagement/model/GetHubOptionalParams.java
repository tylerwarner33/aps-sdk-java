...
package com.autodesk.aps.datamanagement.model;  
 ...
 /**
  * Represents optional parameters for the `getHub` method.
  * This class uses the Builder pattern to allow flexible construction of objects.
  */
public class GetHubOptionalParams{
    private String xUserId;    
    private String accessToken;

    private GetHubOptionalParams(Builder builder){
    ...
    /**
     * Builder class for constructing instances of GetHubOptionalParams.
     */
    public static class Builder {
        ...
        /**
         * Builds and returns an instance of GetHubOptionalParams.
         * 
         * @return GetHubOptionalParams object.
         */
        public GetHubOptionalParams build() {
            return new GetHubOptionalParams(this);
        }
    }
