...
/**
 * Represents optional parameters for the `getVersionRelationshipsRefs` method.
 * This class uses the Builder pattern to allow flexible construction of
 * objects.
 */
public class GetVersionRelationshipsRefsOptionalParams {
    ...
    private GetVersionRelationshipsRefsOptionalParams(Builder builder) {
    ...
    public static class Builder {
        ...
        /**
         * Builds and returns an instance of GetVersionRelationshipsRefsOptionalParams.
         * 
         * @return GetVersionRelationshipsRefsOptionalParams object.
         */
        public GetVersionRelationshipsRefsOptionalParams build() {
            return new GetVersionRelationshipsRefsOptionalParams(this);
        }
    }
