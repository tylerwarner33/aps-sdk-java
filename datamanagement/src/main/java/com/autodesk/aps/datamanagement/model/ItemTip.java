 ...
 */
@Schema(description = "An object that represents the tip version of an item.")
@JsonPropertyOrder({
    ItemTip.JSON_PROPERTY_JSONAPI,
    ItemTip.JSON_PROPERTY_LINKS,
    ItemTip.JSON_PROPERTY_DATA
})
@JsonTypeName("ItemTip")
...
public class ItemTip {
  ...
  public ItemTip jsonapi(JsonApiVersion jsonapi) {
  ...
  public ItemTip links(JsonApiLink links) {
  ...
  public ItemTip data(VersionData data) {
  ...
  public boolean equals(Object o) {
    ...
    ItemTip itemTip = (ItemTip) o;
    return Objects.equals(this.jsonapi, itemTip.jsonapi) &&
        Objects.equals(this.links, itemTip.links) &&
        Objects.equals(this.data, itemTip.data);
  }
