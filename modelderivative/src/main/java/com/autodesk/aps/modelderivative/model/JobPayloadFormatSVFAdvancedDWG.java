...
@JsonPropertyOrder({
    JobPayloadFormatSVFAdvancedDWG.JSON_PROPERTY_2DVIEWS
})
@JsonTypeName("JobPayloadFormatSVFAdvancedDWG")
@JsonIgnoreProperties(ignoreUnknown = true)

public class JobPayloadFormatSVFAdvancedDWG implements JobPayloadFormatSVFAdvanced {
  public static final String JSON_PROPERTY_2DVIEWS = "2dviews";
  private Model2dView _2dviews;

  public JobPayloadFormatSVFAdvancedDWG _2dviews(Model2dView _2dviews) {
  ...
  public boolean equals(Object o) {
    ...
    JobPayloadFormatSVFAdvancedDWG jobPayloadFormatSVFAdvancedDWG = (JobPayloadFormatSVFAdvancedDWG) o;
    return Objects.equals(this._2dviews, jobPayloadFormatSVFAdvancedDWG._2dviews);
  }
  ...
  public String toString() {
    ...
    sb.append("class JobPayloadFormatSVFAdvancedDWG {\n");
