...
@JsonPropertyOrder({
    JobPayloadFormatSVFAdvancedDGN.JSON_PROPERTY_REQUESTED_LINKAGE_I_DS
})
@JsonTypeName("JobPayloadFormatSVFAdvancedDGN")
@JsonIgnoreProperties(ignoreUnknown = true)

public class JobPayloadFormatSVFAdvancedDGN implements JobPayloadFormatSVFAdvanced {
  ...
  public JobPayloadFormatSVFAdvancedDGN requestedLinkageIDs(List<Integer> requestedLinkageIDs) {

    this.requestedLinkageIDs = requestedLinkageIDs;
    return this;
  }

  public JobPayloadFormatSVFAdvancedDGN addrequestedLinkageIDsItem(Integer requestedLinkageIDsItem) {
  ...
  public boolean equals(Object o) {
    ...
    JobPayloadFormatSVFAdvancedDGN jobPayloadFormatSVFAdvancedDGN = (JobPayloadFormatSVFAdvancedDGN) o;
    return Objects.equals(this.requestedLinkageIDs, jobPayloadFormatSVFAdvancedDGN.requestedLinkageIDs);
  }
  ...
  public String toString() {
    ...
    sb.append("class JobPayloadFormatSVFAdvancedDGN {\n");
