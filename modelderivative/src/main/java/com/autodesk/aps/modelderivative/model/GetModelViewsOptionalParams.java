...
package com.autodesk.aps.modelderivative.model;  
 ...
 /**
  * Represents optional parameters for the `getModelViews` method.
  * This class uses the Builder pattern to allow flexible construction of objects.
  */
public class GetModelViewsOptionalParams{
    private String acceptEncoding;    
    private Region region;    
    private String accessToken;

    private GetModelViewsOptionalParams(Builder builder){
...
this.region = builder.region;    
    ...
    /**
     * Builder class for constructing instances of GetModelViewsOptionalParams.
     */
 ...
 * 
        ...
        /**
         * Builds and returns an instance of GetModelViewsOptionalParams.
         * 
         * @return GetModelViewsOptionalParams object.
         */
        public GetModelViewsOptionalParams build() {
            return new GetModelViewsOptionalParams(this);
        }
    }
