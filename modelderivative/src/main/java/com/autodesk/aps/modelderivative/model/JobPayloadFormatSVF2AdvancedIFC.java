...
@JsonPropertyOrder({
    JobPayloadFormatSVF2AdvancedIFC.JSON_PROPERTY_CONVERSION_METHOD,
    JobPayloadFormatSVF2AdvancedIFC.JSON_PROPERTY_BUILDING_STOREYS,
    JobPayloadFormatSVF2AdvancedIFC.JSON_PROPERTY_SPACES,
    JobPayloadFormatSVF2AdvancedIFC.JSON_PROPERTY_OPENING_ELEMENTS
})
@JsonTypeName("JobPayloadFormatSVF2AdvancedIFC")
@JsonIgnoreProperties(ignoreUnknown = true)

public class JobPayloadFormatSVF2AdvancedIFC implements JobPayloadFormatSVF2Advanced {
  ...
  public JobPayloadFormatSVF2AdvancedIFC conversionMethod(ConversionMethod conversionMethod) {
  ...
  public JobPayloadFormatSVF2AdvancedIFC buildingStoreys(BuildingStoreys buildingStoreys) {
  ...
  public JobPayloadFormatSVF2AdvancedIFC spaces(Spaces spaces) {
  ...
  public JobPayloadFormatSVF2AdvancedIFC openingElements(OpeningElements openingElements) {
  ...
  public boolean equals(Object o) {
    ...
    JobPayloadFormatSVF2AdvancedIFC jobPayloadFormatSVF2AdvancedIFC = (JobPayloadFormatSVF2AdvancedIFC) o;
    return Objects.equals(this.conversionMethod, jobPayloadFormatSVF2AdvancedIFC.conversionMethod) &&
        Objects.equals(this.buildingStoreys, jobPayloadFormatSVF2AdvancedIFC.buildingStoreys) &&
        Objects.equals(this.spaces, jobPayloadFormatSVF2AdvancedIFC.spaces) &&
        Objects.equals(this.openingElements, jobPayloadFormatSVF2AdvancedIFC.openingElements);
  }
  ...
  public String toString() {
    ...
    sb.append("class JobPayloadFormatSVF2AdvancedIFC {\n");
