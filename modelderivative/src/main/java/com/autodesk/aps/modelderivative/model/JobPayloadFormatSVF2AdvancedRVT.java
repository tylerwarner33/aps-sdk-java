...
@JsonPropertyOrder({
    JobPayloadFormatSVF2AdvancedRVT.JSON_PROPERTY_2DVIEWS,
    JobPayloadFormatSVF2AdvancedRVT.JSON_PROPERTY_EXTRACTOR_VERSION,
    JobPayloadFormatSVF2AdvancedRVT.JSON_PROPERTY_GENERATE_MASTER_VIEWS,
    JobPayloadFormatSVF2AdvancedRVT.JSON_PROPERTY_MATERIAL_MODE
})
@JsonTypeName("JobPayloadFormatSVF2AdvancedRVT")
@JsonIgnoreProperties(ignoreUnknown = true)

public class JobPayloadFormatSVF2AdvancedRVT implements JobPayloadFormatSVF2Advanced {
  ...
  public JobPayloadFormatSVF2AdvancedRVT _2dviews(Model2dView _2dviews) {
  ...
  public JobPayloadFormatSVF2AdvancedRVT extractorVersion(ExtractorVersion extractorVersion) {
  ...
  public JobPayloadFormatSVF2AdvancedRVT generateMasterViews(Boolean generateMasterViews) {
  ...
  public JobPayloadFormatSVF2AdvancedRVT materialMode(MaterialMode materialMode) {
  ...
  public boolean equals(Object o) {
    ...
    JobPayloadFormatSVF2AdvancedRVT jobPayloadFormatSVF2AdvancedRVT = (JobPayloadFormatSVF2AdvancedRVT) o;
    return Objects.equals(this._2dviews, jobPayloadFormatSVF2AdvancedRVT._2dviews) &&
        Objects.equals(this.extractorVersion, jobPayloadFormatSVF2AdvancedRVT.extractorVersion) &&
        Objects.equals(this.generateMasterViews, jobPayloadFormatSVF2AdvancedRVT.generateMasterViews) &&
        Objects.equals(this.materialMode, jobPayloadFormatSVF2AdvancedRVT.materialMode);
  }
  ...
  public String toString() {
    ...
    sb.append("class JobPayloadFormatSVF2AdvancedRVT {\n");
