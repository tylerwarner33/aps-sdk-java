 ...
 * 
 * @param urn The URL-safe Base64 encoded URN of the source design. (required)
 * @param deleteManifestOptionaParams class containing all optional parameters for the deleteManifest method.
 * @return DeleteManifest
 * @throws ModelDerivativeApiException when an API call fails.
 */


public DeleteManifest deleteManifest(String urn, DeleteManifestOptionalParams deleteManifestOptionalParams) throws ModelDerivativeApiException {
  try  {
        ...
        return manifestApi.deleteManifest(urn, deleteManifestOptionalParams.getRegion(), deleteManifestOptionalParams.getAccessToken()).getData();
 ...
 * @param urn The URL-safe Base64 encoded URN of the source design. (required)
 * @param modelGuid The ID of the Model View you are querying. Use the &#x60;List Model Views &lt;/en/docs/model-derivative/v2/reference/http/metadata/urn-metadata-GET&gt;&#x60;_ operation to get the IDs of the Model Views in the source design. (required)
 * @param specificPropertiesPayload  (required)
 * @return SpecificProperties
 * @throws ModelDerivativeApiException when an API call fails.
 */

public SpecificProperties fetchSpecificProperties(String urn, String modelGuid, SpecificPropertiesPayload specificPropertiesPayload) throws ModelDerivativeApiException {
 ...
 * @param modelGuid The ID of the Model View you are querying. Use the &#x60;List Model Views &lt;/en/docs/model-derivative/v2/reference/http/metadata/urn-metadata-GET&gt;&#x60;_ operation to get the IDs of the Model Views in the source design. (required)
 * @param specificPropertiesPayload  (required)
 * @param fetchSpecificPropertiesOptionaParams class containing all optional parameters for the fetchSpecificProperties method.
 * @return SpecificProperties
 * @throws ModelDerivativeApiException when an API call fails.
 */


public SpecificProperties fetchSpecificProperties(String urn, String modelGuid, SpecificPropertiesPayload specificPropertiesPayload, FetchSpecificPropertiesOptionalParams fetchSpecificPropertiesOptionalParams) throws ModelDerivativeApiException {
  try  {
        ...
        if (fetchSpecificPropertiesOptionalParams.getAccessToken() == null && this.getAuthenticationProvider() == null) {
                throw new ModelDerivativeApiException("Please provide a valid access token!");
        ...
        return metadataApi.fetchSpecificProperties(urn, modelGuid, specificPropertiesPayload, fetchSpecificPropertiesOptionalParams.getAcceptEncoding(), fetchSpecificPropertiesOptionalParams.getRegion(), fetchSpecificPropertiesOptionalParams.getXAdsDerivativeFormat(), fetchSpecificPropertiesOptionalParams.getAccessToken()).getData();
        } catch (ModelDerivativeApiException  e) {
            throw e;
        } catch (Exception e) {
            throw new ModelDerivativeApiException (e);
 ...
 * @param urn The URL-safe Base64 encoded URN of the source design. (required)
 * @param modelGuid The ID of the Model View you are querying. Use the &#x60;List Model Views &lt;/en/docs/model-derivative/v2/reference/http/metadata/urn-metadata-GET&gt;&#x60;_ operation to get the IDs of the Model Views in the source design. (required)
 * @param getAllPropertiesOptionaParams class containing all optional parameters for the getAllProperties method.
 * @return Properties
 * @throws ModelDerivativeApiException when an API call fails.
 */


public Properties getAllProperties(String urn, String modelGuid, GetAllPropertiesOptionalParams getAllPropertiesOptionalParams) throws ModelDerivativeApiException {
  try  {
        ...
        return metadataApi.getAllProperties(urn, modelGuid, getAllPropertiesOptionalParams.getAcceptEncoding(), getAllPropertiesOptionalParams.getXAdsForce(), getAllPropertiesOptionalParams.getXAdsDerivativeFormat(), getAllPropertiesOptionalParams.getRegion(), getAllPropertiesOptionalParams.getObjectid(), getAllPropertiesOptionalParams.getForceget(), getAllPropertiesOptionalParams.getAccessToken()).getData();
        } catch (ModelDerivativeApiException  e) {
            throw e;
        } catch (Exception e) {
            throw new ModelDerivativeApiException (e);
 ...
 * @param derivativeUrn The URL-encoded URN of the derivative. Use the &#x60;Fetch Manifest operation &lt;/en/docs/model-derivative/v2/reference/http/manifest/urn-manifest-GET/&gt;&#x60;_to obtain the URNs of derivatives for the specified source design. (required)
 * @param urn The URL-safe Base64 encoded URN of the source design. (required)
 ...
 * @param derivativeUrn The URL-encoded URN of the derivative. Use the &#x60;Fetch Manifest operation &lt;/en/docs/model-derivative/v2/reference/http/manifest/urn-manifest-GET/&gt;&#x60;_to obtain the URNs of derivatives for the specified source design. (required)
 * @param urn The URL-safe Base64 encoded URN of the source design. (required)
 * @param getDerivativeUrlOptionaParams class containing all optional parameters for the getDerivativeUrl method.
 * @return DerivativeDownload
 * @throws ModelDerivativeApiException when an API call fails.
 */


public DerivativeDownload getDerivativeUrl(String derivativeUrn, String urn, GetDerivativeUrlOptionalParams getDerivativeUrlOptionalParams) throws ModelDerivativeApiException {
  try  {
        ...
        return derivativesApi.getDerivativeUrl(derivativeUrn, urn, getDerivativeUrlOptionalParams.getMinutesExpiration(), getDerivativeUrlOptionalParams.getResponseContentDisposition(), getDerivativeUrlOptionalParams.getRegion(), getDerivativeUrlOptionalParams.getAccessToken()).getData();
        } catch (ModelDerivativeApiException  e) {
            throw e;
        } catch (Exception e) {
            throw new ModelDerivativeApiException (e);
 ...
 * 
 * **Note:** We keep adding new file formats to our supported translations list, constantly.
 * @param getFormatsOptionaParams class containing all optional parameters for the getFormats method.
 * @return SupportedFormats
 * @throws ModelDerivativeApiException when an API call fails.
 */


public SupportedFormats getFormats(GetFormatsOptionalParams getFormatsOptionalParams) throws ModelDerivativeApiException {
  try  {
        ...
        return informationalApi.getFormats(getFormatsOptionalParams.getIfModifiedSince(), getFormatsOptionalParams.getAcceptEncoding(), getFormatsOptionalParams.getAccessToken()).getData();
        } catch (ModelDerivativeApiException  e) {
            throw e;
        } catch (Exception e) {
            throw new ModelDerivativeApiException (e);
 ...
 * **Note:** You cannot download 3D SVF2 derivatives.
 * @param urn The URL-safe Base64 encoded URN of the source design. (required)
 * @param getManifestOptionaParams class containing all optional parameters for the getManifest method.
 * @return Manifest
 * @throws ModelDerivativeApiException when an API call fails.
 */


public Manifest getManifest(String urn, GetManifestOptionalParams getManifestOptionalParams) throws ModelDerivativeApiException {
  try  {
        ...
        return manifestApi.getManifest(urn, getManifestOptionalParams.getAcceptEncoding(), getManifestOptionalParams.getRegion(), getManifestOptionalParams.getAccessToken()).getData();
        } catch (ModelDerivativeApiException  e) {
            throw e;
        } catch (Exception e) {
            throw new ModelDerivativeApiException (e);
 ...
 * **Note:** You can retrieve metadata only from a design that has already been translated to SVF or SVF2.
 * @param urn The URL-safe Base64 encoded URN of the source design. (required)
 * @param getModelViewsOptionaParams class containing all optional parameters for the getModelViews method.
 * @return ModelViews
 * @throws ModelDerivativeApiException when an API call fails.
 */


public ModelViews getModelViews(String urn, GetModelViewsOptionalParams getModelViewsOptionalParams) throws ModelDerivativeApiException {
  try  {
        ...
        return metadataApi.getModelViews(urn, getModelViewsOptionalParams.getAcceptEncoding(), getModelViewsOptionalParams.getRegion(), getModelViewsOptionalParams.getAccessToken()).getData();
        } catch (ModelDerivativeApiException  e) {
            throw e;
        } catch (Exception e) {
            throw new ModelDerivativeApiException (e);
 ...
 * 
 * @param urn The URL-safe Base64 encoded URN of the source design. (required)
 * @param modelGuid The ID of the Model View you are extracting the object tree from. Use the &#x60;List Model Views &lt;/en/docs/model-derivative/v2/reference/http/metadata/urn-metadata-GET&gt;&#x60;_ operation to get the IDs of the Model Views in the source design. (required)
 * @return ObjectTree
 * @throws ModelDerivativeApiException when an API call fails.
 */
 ...
 * @param urn The URL-safe Base64 encoded URN of the source design. (required)
 * @param modelGuid The ID of the Model View you are extracting the object tree from. Use the &#x60;List Model Views &lt;/en/docs/model-derivative/v2/reference/http/metadata/urn-metadata-GET&gt;&#x60;_ operation to get the IDs of the Model Views in the source design. (required)
 * @param getObjectTreeOptionaParams class containing all optional parameters for the getObjectTree method.
 * @return ObjectTree
 * @throws ModelDerivativeApiException when an API call fails.
 */


public ObjectTree getObjectTree(String urn, String modelGuid, GetObjectTreeOptionalParams getObjectTreeOptionalParams) throws ModelDerivativeApiException {
  try  {
        ...
        return metadataApi.getObjectTree(urn, modelGuid, getObjectTreeOptionalParams.getAcceptEncoding(), getObjectTreeOptionalParams.getRegion(), getObjectTreeOptionalParams.getXAdsForce(), getObjectTreeOptionalParams.getXAdsDerivativeFormat(), getObjectTreeOptionalParams.getForceget(), getObjectTreeOptionalParams.getObjectid(), getObjectTreeOptionalParams.getLevel(), getObjectTreeOptionalParams.getAccessToken()).getData();
        } catch (ModelDerivativeApiException  e) {
            throw e;
        } catch (Exception e) {
            throw new ModelDerivativeApiException (e);
 ...
 * Downloads a thumbnail of the specified source design.
 * @param urn The URL-safe Base64 encoded URN of the source design. (required)
 * @param getThumbnailOptionaParams class containing all optional parameters for the getThumbnail method.
 * @return InputStream
 * @throws ModelDerivativeApiException when an API call fails.
 */


public InputStream getThumbnail(String urn, GetThumbnailOptionalParams getThumbnailOptionalParams) throws ModelDerivativeApiException {
  try  {
        ...
        return thumbnailsApi.getThumbnail(urn, getThumbnailOptionalParams.getRegion(), getThumbnailOptionalParams.getWidth(), getThumbnailOptionalParams.getHeight(), getThumbnailOptionalParams.getAccessToken()).getData();
        } catch (ModelDerivativeApiException  e) {
            throw e;
        } catch (Exception e) {
            throw new ModelDerivativeApiException (e);
 ...
 * @param urn The URL-safe Base64 encoded URN of the source design. (required)
 * @param derivativeUrn The URL-encoded URN of the derivative. Check the manifest of the source design to get the URNs of the derivatives available for download. (required)
 * @throws ModelDerivativeApiException when an API call fails.
 */
 ...
 * @param urn The URL-safe Base64 encoded URN of the source design. (required)
 * @param derivativeUrn The URL-encoded URN of the derivative. Check the manifest of the source design to get the URNs of the derivatives available for download. (required)
 * @param headCheckDerivativeOptionaParams class containing all optional parameters for the headCheckDerivative method.
 * @throws ModelDerivativeApiException when an API call fails.
 */


public void headCheckDerivative(String urn, String derivativeUrn, HeadCheckDerivativeOptionalParams headCheckDerivativeOptionalParams) throws ModelDerivativeApiException {
  try  {
        ...
        if (headCheckDerivativeOptionalParams.getAccessToken() == null && this.getAuthenticationProvider() == null) {
                throw new ModelDerivativeApiException("Please provide a valid access token!");
        ...
        derivativesApi.headCheckDerivative(urn, derivativeUrn, headCheckDerivativeOptionalParams.getRegion(), headCheckDerivativeOptionalParams.getAccessToken()).getData();
        } catch (ModelDerivativeApiException  e) {
            throw e;
        } catch (Exception e) {
            throw new ModelDerivativeApiException (e);
...
public SpecifyReferences specifyReferences(String urn, SpecifyReferencesPayload specifyReferencesPayload) throws ModelDerivativeApiException {
 ...
 * @param urn The Base64 (URL Safe) encoded design URN. (required)
 * @param specifyReferencesPayload  (required)
 * @param specifyReferencesOptionaParams class containing all optional parameters for the specifyReferences method.
 * @return SpecifyReferences
 * @throws ModelDerivativeApiException when an API call fails.
 */


public SpecifyReferences specifyReferences(String urn, SpecifyReferencesPayload specifyReferencesPayload, SpecifyReferencesOptionalParams specifyReferencesOptionalParams) throws ModelDerivativeApiException {
  try  {
        ...
        return jobsApi.specifyReferences(urn, specifyReferencesPayload, specifyReferencesOptionalParams.getRegion(), specifyReferencesOptionalParams.getAccessToken()).getData();
        } catch (ModelDerivativeApiException  e) {
            throw e;
        } catch (Exception e) {
            throw new ModelDerivativeApiException (e);
 ...
 * If necessary, you can set the &#x60;&#x60;x-ads-force&#x60;&#x60; parameter to &#x60;&#x60;true&#x60;&#x60;. Then, the system will delete the existing manifest and create a new one. However, be aware that doing so will also delete all previously generated derivatives.
 * @param jobPayload  (required)
 * @param startJobOptionaParams class containing all optional parameters for the startJob method.
 * @return Job
 * @throws ModelDerivativeApiException when an API call fails.
 */


public Job startJob(JobPayload jobPayload, StartJobOptionalParams startJobOptionalParams) throws ModelDerivativeApiException {
  try  {
        ...
        return jobsApi.startJob(jobPayload, startJobOptionalParams.getXAdsForce(), startJobOptionalParams.getXAdsDerivativeFormat(), startJobOptionalParams.getRegion(), startJobOptionalParams.getAccessToken()).getData();
        } catch (ModelDerivativeApiException  e) {
            throw e;
        } catch (Exception e) {
            throw new ModelDerivativeApiException (e);
