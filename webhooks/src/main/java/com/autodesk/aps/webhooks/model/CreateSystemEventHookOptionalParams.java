...
package com.autodesk.aps.webhooks.model;  
 ...
 /**
  * Represents optional parameters for the `createSystemEventHook` method.
  * This class uses the Builder pattern to allow flexible construction of objects.
  */
public class CreateSystemEventHookOptionalParams{
    private Region region;    
    private XAdsRegion xAdsRegion;    
    private String accessToken;

    private CreateSystemEventHookOptionalParams(Builder builder){
...
this.xAdsRegion = builder.xAdsRegion;    
    ...
    /**
     * Builder class for constructing instances of CreateSystemEventHookOptionalParams.
     */
 ...
 * 
        ...
        /**
         * Builds and returns an instance of CreateSystemEventHookOptionalParams.
         * 
         * @return CreateSystemEventHookOptionalParams object.
         */
        public CreateSystemEventHookOptionalParams build() {
            return new CreateSystemEventHookOptionalParams(this);
        }
    }
