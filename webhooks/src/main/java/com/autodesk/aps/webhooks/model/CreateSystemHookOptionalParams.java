...
package com.autodesk.aps.webhooks.model;  
 ...
 /**
  * Represents optional parameters for the `createSystemHook` method.
  * This class uses the Builder pattern to allow flexible construction of objects.
  */
public class CreateSystemHookOptionalParams{
    private XAdsRegion xAdsRegion;    
    private Region region;    
    private String accessToken;

    private CreateSystemHookOptionalParams(Builder builder){
...
this.region = builder.region;    
    ...
    /**
     * Builder class for constructing instances of CreateSystemHookOptionalParams.
     */
 ...
 * 
        ...
        /**
         * Builds and returns an instance of CreateSystemHookOptionalParams.
         * 
         * @return CreateSystemHookOptionalParams object.
         */
        public CreateSystemHookOptionalParams build() {
            return new CreateSystemHookOptionalParams(this);
        }
    }
