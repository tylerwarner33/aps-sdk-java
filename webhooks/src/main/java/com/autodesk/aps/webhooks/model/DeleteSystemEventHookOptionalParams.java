...
package com.autodesk.aps.webhooks.model;  
 ...
 /**
  * Represents optional parameters for the `deleteSystemEventHook` method.
  * This class uses the Builder pattern to allow flexible construction of objects.
  */
public class DeleteSystemEventHookOptionalParams{
    private XAdsRegion xAdsRegion;    
    private Region region;    
    private String accessToken;

    private DeleteSystemEventHookOptionalParams(Builder builder){
...
this.region = builder.region;    
    ...
    /**
     * Builder class for constructing instances of DeleteSystemEventHookOptionalParams.
     */
 ...
 * 
        ...
        /**
         * Builds and returns an instance of DeleteSystemEventHookOptionalParams.
         * 
         * @return DeleteSystemEventHookOptionalParams object.
         */
        public DeleteSystemEventHookOptionalParams build() {
            return new DeleteSystemEventHookOptionalParams(this);
        }
    }
