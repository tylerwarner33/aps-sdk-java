...
package com.autodesk.aps.webhooks.model;  
 ...
 /**
  * Represents optional parameters for the `getSystemEventHooks` method.
  * This class uses the Builder pattern to allow flexible construction of objects.
  */
public class GetSystemEventHooksOptionalParams{
    ...
    private GetSystemEventHooksOptionalParams(Builder builder){
...
this.status = builder.status;    
    ...
    /**
     * Builder class for constructing instances of GetSystemEventHooksOptionalParams.
     */
 ...
 * 
        ...
        /**
         * @param scopeName Filters retrieved webhooks by the scope name used to create hook. For example : &#x60;&#x60;folder&#x60;&#x60;.  If this parameter is not specified, the filter is not applied.
         *
         * @return The Builder instance for chaining.
         */
 ...
 * 
        ...
        /**
         * Builds and returns an instance of GetSystemEventHooksOptionalParams.
         * 
         * @return GetSystemEventHooksOptionalParams object.
         */
        public GetSystemEventHooksOptionalParams build() {
            return new GetSystemEventHooksOptionalParams(this);
        }
    }
