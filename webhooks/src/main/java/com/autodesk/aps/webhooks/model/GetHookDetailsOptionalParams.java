...
package com.autodesk.aps.webhooks.model;  
 ...
 /**
  * Represents optional parameters for the `getHookDetails` method.
  * This class uses the Builder pattern to allow flexible construction of objects.
  */
public class GetHookDetailsOptionalParams{
    private XAdsRegion xAdsRegion;    
    private Region region;    
    private String accessToken;

    private GetHookDetailsOptionalParams(Builder builder){
...
this.region = builder.region;    
    ...
    /**
     * Builder class for constructing instances of GetHookDetailsOptionalParams.
     */
 ...
 * 
        ...
        /**
         * Builds and returns an instance of GetHookDetailsOptionalParams.
         * 
         * @return GetHookDetailsOptionalParams object.
         */
        public GetHookDetailsOptionalParams build() {
            return new GetHookDetailsOptionalParams(this);
        }
    }
