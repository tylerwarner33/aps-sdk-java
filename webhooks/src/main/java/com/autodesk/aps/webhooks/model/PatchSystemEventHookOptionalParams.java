...
package com.autodesk.aps.webhooks.model;  
 ...
 /**
  * Represents optional parameters for the `patchSystemEventHook` method.
  * This class uses the Builder pattern to allow flexible construction of objects.
  */
public class PatchSystemEventHookOptionalParams{
    private XAdsRegion xAdsRegion;    
    private Region region;    
    private String accessToken;

    private PatchSystemEventHookOptionalParams(Builder builder){
...
this.region = builder.region;    
    ...
    /**
     * Builder class for constructing instances of PatchSystemEventHookOptionalParams.
     */
 ...
 * 
        ...
        /**
         * Builds and returns an instance of PatchSystemEventHookOptionalParams.
         * 
         * @return PatchSystemEventHookOptionalParams object.
         */
        public PatchSystemEventHookOptionalParams build() {
            return new PatchSystemEventHookOptionalParams(this);
        }
    }
