...
package com.autodesk.aps.webhooks.model;  
 ...
 /**
  * Represents optional parameters for the `getAppHooks` method.
  * This class uses the Builder pattern to allow flexible construction of objects.
  */
public class GetAppHooksOptionalParams{
    ...
    private GetAppHooksOptionalParams(Builder builder){
...
this.region = builder.region;    
    ...
    /**
     * Builder class for constructing instances of GetAppHooksOptionalParams.
     */
 ...
 * 
        ...
        /**
         * @param sort Specifies the sorting order of the list of webhooks by their &#x60;&#x60;lastUpdatedDate&#x60;&#x60; attribute. 
 * 
 * - &#x60;&#x60;asc&#x60;&#x60; - Ascending order.
 ...
 * 
        ...
        /**
         * Builds and returns an instance of GetAppHooksOptionalParams.
         * 
         * @return GetAppHooksOptionalParams object.
         */
        public GetAppHooksOptionalParams build() {
            return new GetAppHooksOptionalParams(this);
        }
    }
