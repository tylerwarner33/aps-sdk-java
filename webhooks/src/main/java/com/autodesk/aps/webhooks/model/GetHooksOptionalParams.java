...
package com.autodesk.aps.webhooks.model;  
 ...
 /**
  * Represents optional parameters for the `getHooks` method.
  * This class uses the Builder pattern to allow flexible construction of objects.
  */
public class GetHooksOptionalParams{
    ...
    private GetHooksOptionalParams(Builder builder){
...
this.xAdsRegion = builder.xAdsRegion;    
    ...
    /**
     * Builder class for constructing instances of GetHooksOptionalParams.
     */
 ...
 * 
        ...
        /**
         * Builds and returns an instance of GetHooksOptionalParams.
         * 
         * @return GetHooksOptionalParams object.
         */
        public GetHooksOptionalParams build() {
            return new GetHooksOptionalParams(this);
        }
    }
