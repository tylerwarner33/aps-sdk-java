...
package com.autodesk.aps.webhooks.model;  
 ...
 /**
  * Represents optional parameters for the `deleteToken` method.
  * This class uses the Builder pattern to allow flexible construction of objects.
  */
public class DeleteTokenOptionalParams{
    private XAdsRegion xAdsRegion;    
    private Region region;    
    private String accessToken;

    private DeleteTokenOptionalParams(Builder builder){
...
this.region = builder.region;    
    ...
    /**
     * Builder class for constructing instances of DeleteTokenOptionalParams.
     */
 ...
 * 
        ...
        /**
         * Builds and returns an instance of DeleteTokenOptionalParams.
         * 
         * @return DeleteTokenOptionalParams object.
         */
        public DeleteTokenOptionalParams build() {
            return new DeleteTokenOptionalParams(this);
        }
    }
