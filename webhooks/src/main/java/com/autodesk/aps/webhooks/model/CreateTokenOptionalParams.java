...
package com.autodesk.aps.webhooks.model;  
 ...
 /**
  * Represents optional parameters for the `createToken` method.
  * This class uses the Builder pattern to allow flexible construction of objects.
  */
public class CreateTokenOptionalParams{
    private XAdsRegion xAdsRegion;    
    private Region region;    
    private String accessToken;

    private CreateTokenOptionalParams(Builder builder){
...
this.region = builder.region;    
    ...
    /**
     * Builder class for constructing instances of CreateTokenOptionalParams.
     */
 ...
 * 
        ...
        /**
         * Builds and returns an instance of CreateTokenOptionalParams.
         * 
         * @return CreateTokenOptionalParams object.
         */
        public CreateTokenOptionalParams build() {
            return new CreateTokenOptionalParams(this);
        }
    }
